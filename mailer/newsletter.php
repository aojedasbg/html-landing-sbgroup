...
$email = isset($_POST['email']) ? $_POST['email'] : "-";
	...
	$mail->SetFrom("pruebaslumston@gmail.com", "SB Group | Noticias");
	...
	//mail to Support
	$mail->AddAddress($Support_mail, "SB Group | Noticias");
